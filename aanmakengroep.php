...
<div class="hidden sm:block" aria-hidden="true">
                                        ...
                                        <div class="flex flex-wrap mb-6">
                                            ...
                                            <form action="groepInsert.php" method="post">
                                                        ...
                                                        <div class="mt-1 focus:ring-black-500 focus:border-black-500 block w-full shadow-sm sm:text-sm border-black-900 rounded-md">
                                                            ...
                                                            <div class="flex-grow"><input type="text" name="locatie" class="rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" required /></div>
                                                        </div>
  ...
  <select class="border border-gray-300 rounded-full text-gray-600 h-10 pl-5 pr-10 bg-white hover:border-gray-400 focus:outline-none appearance-none">
    ...
    <option>Tafel 1</option>
    <option>Tafel 2</option>
    <option>Tafel 3</option>
    <option>Tafel 4</option>
    <option>Cabine 1</option>
    <option>Cabine 2</option>
    <option>Cabine 3</option>
    <option>Cabine 4</option>    
    <option>C104</option>
  </select>
</div> -->
